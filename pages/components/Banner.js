            ...
            <div className=" bg-gray-50 flex items-center ">
                <section className="w-full bg-cover bg-center py-32" style={{ backgroundImage: "url('/images/yellowbanner.jpg')" }}>
                    <div className="container mx-auto text-center text-white">
                        ...
                        <Link href="https://drive.google.com/file/d/1xh_9pnGzdAO7_q-dq8xtb44vPq9v6vLq/view?usp=sharing" target='_blank' className="bg-black text-white py-4 px-12 rounded-full hover:bg-white hover:text-black hover:border border-black transition">View Resume</Link>
                        <br />
